    ...
    <div class="wrap">
        ...
        <form action="options.php" method="post">
            ...
            <table class="form-table">
                <tbody>
                    <tr valign="top">
                        <th scope="row"><?php _e('Excluded Categories', 'b3p1'); ?></th>
                        <td>
                            <?php foreach ($categories as $category) : ?>
                                <label>
                                    <input type="checkbox" name="b3p1_excluded_categories[]" value="<?php echo esc_attr($category->term_id); ?>" <?php checked(in_array($category->term_id, $excluded_categories), true); ?>>
